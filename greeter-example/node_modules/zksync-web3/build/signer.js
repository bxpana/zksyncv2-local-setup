...
exports.eip712Types = {
    TransactionRequest: [
        ...
        { name: 'ergsPerStorage', type: 'uint256' },
        { name: 'ergsPerPubdata', type: 'uint256' },
        { name: 'feeToken', type: 'address' },
        { name: 'withdrawToken', type: 'address' }
    ]
};
class EIP712Signer {
    constructor(ethSigner, chainId) {
        ...
        this.eip712Domain = Promise.resolve(chainId).then((chainId) => ({
            ...
            verifyingContract: ethers_1.ethers.constants.AddressZero
        }));
    }
    ...
    static getSignedDigest(transaction) {
        ...
        return hash_1._TypedDataEncoder.hash(domain, exports.eip712Types, signInput);
    }
}
